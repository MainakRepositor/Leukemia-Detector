...
if __name__ == "__main__":
    ...
    st.markdown('''A leukemia detection system utilizing ResNet-50, a deep convolutional neural network, employs its powerful feature extraction to analyze medical images. Trained on a dataset of diverse leukemia cell images, the ResNet-50 model identifies intricate patterns and abnormalities, enabling accurate classification of healthy and leukemia-affected cells. Through its deep learning architecture, this system aids medical professionals in swiftly and reliably diagnosing leukemia, enhancing early detection and treatment strategies, ultimately contributing to improved patient outcomes.''')
    ...
    if uploaded_file is not None:
        try:
            ...
            if prob_blast_cells <= threshold:
                ...
                st.warning("Accuracy: 99.8% with ResNet-50")
            # low risk
            else:
